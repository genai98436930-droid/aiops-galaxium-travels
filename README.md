...
- **Backend**: [backend/README.md](backend/README.md) - API endpoints, MCP tools, database schema
- **Frontend**: [frontend/README.md](frontend/README.md) - Components, styling, build instructions
